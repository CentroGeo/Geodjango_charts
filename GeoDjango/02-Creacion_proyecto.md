...
**Json** por sus siglas JavaScript Object Notation (notación de objetos javascritp) y siendo **Geojson** un tipo de json particular para datos espaciales, para más información consultar  
**https://www.json.org/json-es.html**  


[Modelos django](https://centrogeo.github.io/Geodjango_charts/GeoDjango/03-Modelos_Django.html)
